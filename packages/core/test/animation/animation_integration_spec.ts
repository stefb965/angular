 ...
 */
import {AUTO_STYLE, AnimationEvent, AnimationPlayer, animate, animateChild, group, keyframes, query, queryAll, state, style, transition, trigger, ɵStyleData} from '@angular/animations';
